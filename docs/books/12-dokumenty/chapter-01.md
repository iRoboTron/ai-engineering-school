...
В ноутбуке ты сделаешь картинку сам, в Python. Значит, правильный ответ будет известен заранее, и код сможет честно посчитать, сколько раз модель ошиблась. При подготовке лаборатории вышло так: расписание модель прочитала без единой ошибки (18 клеток из 18), а круги посчитала верно в половине случаев — 20 кругов превратились в 19 и в 16.

И ещё одно наблюдение оттуда же: на картинке в 300 точек модель прочитала все клетки верно, но потеряла скобки у JSON-списка. Если проверка показала провал, сначала посмотри на сырой ответ — сломалось чтение или только формат.

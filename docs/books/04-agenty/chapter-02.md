...
> **Лабораторная этого урока:** пишем агента с двумя инструментами и четырьмя границами.
> - без интернета: [01_agent.py](labs/tema4-agenty/01_agent.py) — запуск `python3 01_agent.py`, разобрана в разделе [«Практика: агент с двумя инструментами и всеми границами»](#практика-агент-с-двумя-инструментами-и-всеми-границами)
> - на настоящей модели: [открыть в Google Colab](https://colab.research.google.com/github/iRoboTron/ai-engineering-school/blob/main/docs/books/labs/tema4-agenty/01_agent_s_granicami.ipynb) · [скачать .ipynb](labs/tema4-agenty/01_agent_s_granicami.ipynb)

...
Главное следствие: короткая память **не бесконечна**, это то самое контекстное окно из темы 1. Когда диалог длинный, старое приходится либо выбрасывать, либо коротко пересказывать, либо сохранять в долгую память. Само по себе ничего не запомнится. Как именно это делают и сколько это экономит — разобрано в [теме 9](../09-istoriya/book.md).

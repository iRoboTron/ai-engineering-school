...
Курс кончился, но это, пожалуй, худший момент останавливаться. Ты уже работал и с живой моделью, и с настоящими библиотеками — значит, дальше идут не «учебные», а обычные инженерные шаги:

...
|---|---|---|
| Нарезка документов на чанки | лаба «мини-RAG» | 2 |
| Поиск подходящих чанков | лаба «мини-RAG» или «поиск по смыслу» | 2, 3 |
| Сборка запроса с правилом не выдумывать | лаба «мини-RAG» | 2 |
| Эталонный набор и замер качества | лаба «проверка» | 5 |
| Проверка ответа кодом | лаба «подмена» | 6 |

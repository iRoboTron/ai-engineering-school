...
|---|---|---|
| «кабинет 204» | Находит точно | Может промахнуться: цифры для него мало значат |
...
- **Поиск по словам** прост и хорош для точных названий и номеров, но не находит текст, где о том же сказано другими словами.

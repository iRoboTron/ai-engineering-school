...
> **Лабораторная этого урока:** собираем мини-RAG: нарезка, поиск, запрос с правилом не выдумывать.
> - без интернета: [01_mini_rag.py](labs/tema2-rag/01_mini_rag.py) — запуск `python3 01_mini_rag.py`, разобрана в разделе [«Практика: собираем свой мини-RAG»](#практика-собираем-свой-мини-rag)
> - на настоящей модели: [открыть в Google Colab](https://colab.research.google.com/github/iRoboTron/ai-engineering-school/blob/main/docs/books/labs/tema2-rag/01_nastoyashchiy_rag.ipynb) · [скачать .ipynb](labs/tema2-rag/01_nastoyashchiy_rag.ipynb)
